        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var payload = [
                    ...
                    ["lc0246", "M", "Math", "Strobogrammatic Number", ""],
                    ["lc0247", "M", "Math", "Strobogrammatic Number II", ""],
                    ["lc0249", "M", "Hashtable", "Group Shifted Strings", ""],
                    ...
                    ["lc0314", "M", "Tree", "Binary Tree Vertical Order Traversal", "跟987比，这题要求同行或同列时，顺序应该从左到右打出来"],
                    ["lc0315", "M", "Segment Tree", "Count of Smaller Numbers After Self", ""],
                    ["lc0316", "M", "String", "Remove Duplicate Letters", ""],
                    ["lc0317", "H", "BFS", "Shortest Distance from All Buildings", "每栋楼做BFS"],
                    ...
                    ["lc0334", "M", "Array", "Increasing Triplet Subsequence", ""],
                    ...
                    ["lc0367", "E", "Binary Search", "Valid Perfect Square", ""],
                    ...
                    ["lc0381", "M", "Design", "Insert Delete GetRandom O\(1\) - Duplicates allowed", ""],
                    ...
                    ["lc0398", "M", "Array", "Random Pick Index", "数组中有重复元素，随机数返回索引 - 蓄水池抽样问题"],
                    ["lc0399", "M", "UF", "Evaluate Division", ""],
                    ["lc0400", "M", "Math", "Nth Digit", ""],
                    ...
                    ["lc0408", "E", "Two Pointers", "Valid Word Abbreviation", ""],
                    ["lc0409", "M", "Hashtable", "Longest Palindrome", ""],
                    ["lc0410", "H", "DP, Binary Search", "Split Array Largest Sum", ""],
                    ...
                    ["lc0419", "M", "Array", "Battleships in a Board", ""],
                    ...
                    ["lc0435", "M", "Sorting", "Non-overlapping Intervals", ""],
                    ...
                    ["lc0477", "M", "Math", "Total Hamming Distance", ""],
                    ["lc0480", "H", "PriorityQueue", "Sliding Window Median", ""],
                    ...
                    ["lc0496", "E", "Array", "Next Greater Element I", ""],
                    ...
                    ["lc0515", "M", "Tree", "Find Largest Value in Each Tree Row", ""],
                    ...
                    ["lc0525", "M", "Hashtable", "Contiguous Array", "最长的子数组，其中包含的0和1同样多数量"],
                    ...
                    ["lc0536", "M", "String", "Construct Binary Tree from String", ""],
                    ...
                    ["lc0681", "M", "DFS", "Next Closest Time", ""],
                    ...
                    ["lc0719", "M", "DFS", "Find K-th Smallest Pair Distance", ""],
                    ...
                    ["lc0742", "M", "Tree", "Closest Leaf in a Binary Tree", ""],
                    ...
                    ["lc0763", "M", "Hashtable", "Partition Labels", ""],
                    ["lc0766", "E", "Array", "Toeplitz Matrix", "判断是否矩阵上每一条由左上到右下的对角线上的元素都相同,托普利茨矩阵"],
                    ...
                    ["lc0778", "H", "Graph", "Swim in Rising Water", ""],
                    ...
                    ["lc0788", "M", "String", "Rotated Digits", ""],
                    ["lc0791", "M", "Hashtable", "Custom Sort String", ""],
                    ...
                    ["lc0809", "M", "String", "Expressive Words", "叠音词"],
                    ...
                    ["lc0824", "M", "String", "Goat Latin", ""],
                    ["lc0825", "M", "Sorting", "Friends Of Appropriate Ages", ""],
                    ["lc0827", "H", "DFS, UF", "Making A Large Island", ""],
                    ...
                    ["lc0852", "E", "Array", "Peak Index in a Mountain Array", ""],
                    ["lc0855", "M", "Design", "Exam Room", ""],
                    ["lc0860", "M", "Greedy", "Lemonade Change", ""],
                    ["lc0862", "H", "Prefix Sum", "Shortest Subarray with Sum at Least K", "总和至少为 k 的 nums 的最短非空子数组的长度"],
                    ["lc0863", "M", "Tree", "All Nodes Distance K in Binary Tree", ""],
                    ["lc0865", "M", "Tree", "Smallest Subtree with all the Deepest Nodes", ""],
                    ["lc0868", "E", "Bit Manipulation", "Binary Gap", ""],
                    ["lc0871", "H", "DP, Stack", "Minimum Number of Refueling Stops", ""],
                    ["lc0875", "M", "Binary Search", "Koko Eating Bananas", ""],
                    ...
                    ["lc0919", "M", "BFS", "Complete Binary Tree Inserter", ""],
                    ...
                    ["lc0951", "M", "Tree", "Flip Equivalent Binary Trees", ""],
                    ["lc0953", "E", "String", "Verifying an Alien Dictionary", "跟269比只是检查顺序"],
                    ["lc0958", "M", "Tree", "Check Completeness of a Binary Tree", ""],
                    ["lc0963", "M", "Array", "Minimum Area Rectangle II", "正方形的边不一定平行于X或Y轴"],
                    ["lc0973", "M", "Divide and Conquer", "K Closest Points from Origin", ""],
                    ["lc0974", "M", "Array", "Subarray Sums Divisible by K", ""],
                    ...
                    ["lc0983", "M", "DP", "Minimum Cost For Tickets", ""],
                    ...
                    ["lc0987", "H", "Tree", "Vertical Order Traversal of a Binary Tree", "跟314比，这题是正常垂直遍历"],
                    ["lc0989", "E", "Array", "Add to Array-Form of Integer", ""],
                    ...
                    ["lc1004", "M", "Sliding Window", "Max Consecutive Ones III", "01数组中可以将k个0变成1，求最多连续的1"],
                    ...
                    ["lc1034", "M", "DFS, BFS", "Coloring A Border", ""],
                    ...
                    ["lc1048", "M", "DP, Sorting", "Longest String Chain", ""],
                    ["lc1049", "M", "String, Stack", "Minimum Remove to Make Valid Parentheses", ""],
                    ["lc1053", "M", "Math", "Previous Permutation With One Swap", ""],
                    ["lc1060", "M", "Binary Search", "Missing Element in Sorted Array", ""],
                    ...
                    ["lc1099", "E", "Two Pointers", "Two Sum Less Than K", ""],
                    ["lc1102", "M", "BFS, Heap", "Path With Maximum Minimum Value", ""],
                    ["lc1104", "M", "Tree", "Path In Zigzag Labelled Binary Tree", ""],
                    ["lc1108", "E", "String", "Defanging an IP Address", ""],
                    ["lc1110", "M", "Tree", "Delete Nodes And Return Forest", "删点成林"],
                    ["lc1123", "M", "Tree", "Lowest Common Ancestor of Deepest Leaves", ""],
                    ["lc1136", "M", "BFS", "Parallel Courses", ""],
                    ...
                    ["lc1160", "E", "Hashtable", "Find Words That Can Be Formed by Characters", ""],
                    ["lc1161", "M", "Tree, BFS", "Maximum Level Sum of a Binary Tree", ""],
                    ["lc1163", "H", "String", "Last Substring in Lexicographical Order", ""],
                    ["lc1168", "H", "Graph, Union Find", "Optimize Water Distribution in a Village", ""],
                    ...
                    ["lc1192", "H", "DFS, Graph", "Critical Connections in a Network", ""],
                    ["lc1197", "M", "BFS", "Minimum Knight Moves", ""],
                    ["lc1200", "E", "Array", "Minimum Absolute Difference", "排序后找出最小差值"],
                    ["lc1202", "M", "Union Find", "Smallest String With Swaps", "交换index使字符串最小"],
                    ...
                    ["lc1213", "E", "Array", "Intersection of Three Sorted Arrays", ""],
                    ["lc1216", "H", "DP", "Valid Palindrome III", "可以移除k个字符再判断是否回文字符串"],
                    ["lc1218", "M", "DP, Hashtable", "Longest Arithmetic Subsequence of Given Difference", ""],
                    ["lc1233", "H", "String", "Remove Sub-Folders from the Filesystem", "Trie"],
                    ...
                    ["lc1245", "M", "DFS, BFS, Tree", "Tree Diameter", ""],
                    ...
                    ["lc1265", "M", "Divide Conquer", "Print Immutable Linked List in Reverse", ""],
                    ["lc1268", "M", "String", "Search Suggestions System", ""],
                    ["lc1269", "H", "DP", "Number of Ways to Stay in the Same Place After Some Steps", ""],
                    ...
                    ["lc1305", "M", "Tree", "All Elements in Two Binary Search Trees", ""],
                    ["lc1312", "H", "DP", "Minimum Insertion Steps to Make a String Palindrome", ""],
                    ["lc1314", "M", "DP", "Matrix Block Sum", "矩阵的区域和，新的矩阵的每个元素都满足一定条件"],
                    ["lc1319", "M", "Union Find", "Number of Operations to Make Network Connected", ""],
                    ...
                    ["lc1382", "M", "Tree", "Balance a Binary Search Tree", ""],
                    ...
                    ["lc1460", "E", "Array", "Make Two Arrays Equal by Reversing Sub-arrays", ""],
                    ...
                    ["lc1485", "M", "Tree", "Clone Binary Tree With Random Pointer", ""],
                    ["lc1487", "M", "Hashtable, Recursion", "Making File Names Unique", ""],
                    ["lc1492", "M", "Math", "The kth Factor of n", ""],
                    ["lc1498", "M", "Sorting, Binary Search", "Number of Subsequences That Satisfy the Given Sum Condition", "满足其最小元素与最大元素的 和 小于或等于 target 的非空 子序列的数目"],
                    ["lc1509", "M", "Array", "Minimum Difference Between Largest and Smallest Value in Three Moves", "排序或贪心"],
                    ["lc1522", "M", "Tree", "Diameter of N-Ary Tree", ""],
                    ["lc1531", "H", "DP", "String Compression II", ""],
                    ["lc1539", "E", "Binary Search", "Kth Missing Positive Number", ""],
                    ["lc1541", "M", "Greedy", "Minimum Insertions to Balance a Parentheses String", ""],
                    ["lc1554", "M", "Hashtable", "Strings Differ by One Character", ""],
                    ["lc1556", "E", "String", "Thousand Separator", ""],
                    ["lc1559", "M", "DFS, BFS, UF", "Detect Cycles in 2D Grid", ""],
                    ["lc1567", "M", "DP, Greedy", "Maximum Length of Subarray With Positive Product", "同152，维持正负两个数组或值"],
                    ["lc1570", "M", "Hashtable, Two Pointers", "Dot Product of Two Sparse Vectors", ""],
                    ...
                    ["lc1644", "M", "Tree", "Lowest Common Ancestor of a Binary Tree II", "跟236比较，结点自己可以作为自己的后裔。"],
                    ...
                    ["lc1748", "E", "Array", "Sum of Unique Elements", ""],
                    ["lc1751", "H", "DP", "Maximum Number of Events That Can Be Attended II", ""],
                    ["lc1757", "E", "SQL", "Recyclable and Low Fat Products", ""],
                    ...
                    ["lc1834", "M", "Sorting, PriorityQueue", "Single-Threaded CPU", ""],
                    ...
                    ["lc1868", "M", "Two Pointers", "Product of Two Run-Length Encoded Arrays", ""],
                    ["lc1882", "M", "Priority Queue", "Process Tasks Using Servers", ""],
                    ["lc1884", "M", "DP", "Egg Drop With 2 Eggs and N Floors", ""],
                    ["lc1891", "M", "Binary Search", "Cutting Ribbons", ""],
                    ...
                    ["lc1944", "H", "Stack", "Number of Visible People in a Queue", "单调栈"],
                    ["lc1953", "M", "Design", "Maximum Number of Weeks for Which You Can Work", "贪心"],
                    ["lc1971", "E", "Graph", "Find if Path Exists in Graph", ""],
                    ["lc1973", "M", "Tree", "Count Nodes Equal to Sum of Descendants", ""],
                    ["lc1985", "M", "Priority Queue", "Find the Kth Largest Integer in the Array", "跟215比就是不是比较整数而是比较字符"],
                    ["lc2007", "M", "Array, Sorting", "Find if Path Exists in Graph", "数组中的元素二倍后打乱后，还原"],
                    ["lc2019", "H", "DP", "The Score of Students Solving Math Expression", ""],
                    ["lc2025", "H", "Array", "Maximum Number of Ways to Partition an Array", ""],
                    ["lc2034", "M", "Hashtable", "Stock Price Fluctuation", ""],
                    ["lc2049", "M", "Tree, DFS", "Count Nodes With the Highest Score", "DFS的同时，计算分数"],
                    ["lc2056", "H", "Array", "Number of Valid Move Combinations On Chessboard", "直接模拟"],
                    ["lc2060", "H", "DP", "Check if an Original String Exists Given Two Encoded Strings", ""],
                    ["lc2061", "M", "Array", "Number of Spaces Cleaning Robot Cleaned", ""],
                    ["lc2065", "H", "Backtracking", "Maximum Path Quality of a Graph", ""],
                    ["lc2073", "E", "Array", "Time Needed to Buy Tickets", "模拟"],
                    ["lc2071", "H", "Binary Search", "Maximum Number of Tasks You Can Assign", ""],
                    ["lc2076", "H", "Union Find", "Process Restricted Friend Requests", ""],
                    ["lc2078", "E", "Greedy", "Two Furthest Houses With Different Colors", ""],
                    ["lc2081", "H", "String", "Sum of k-Mirror Numbers", ""],
                    ["lc2089", "E", "Array", "Find Target Indices After Sorting Array", ""],
                    ["lc2092", "H", "PriorityQueue", "Find All People With Secret", ""]
                    ];
                $('#lc').DataTable({
                    data: payload,
                    columnDefs: [
